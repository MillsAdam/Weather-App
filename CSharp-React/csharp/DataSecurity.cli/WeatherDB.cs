    ...
    public class WeatherDB
    {
        ...
        private void ShowWeather(int zipcode)
        {
            ...
            } else
            {
                ...
                Console.WriteLine(weatherFromDB.weather[0].Description);
                Console.WriteLine(weatherFromDB.weather[0].Main);
                Console.WriteLine(weatherFromDB.main.Temp);
                Console.WriteLine(weatherFromDB.main.Feels_like);
