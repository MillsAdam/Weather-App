...
namespace WeatherDB.Cli.Security
{
    public interface IPasswordHasher
    {
        /// <summary>
        /// Given a clear text password and a salt, hash the password and return the computed hash.
        /// </summary>
        ...
        /// <returns>a new random array of bytes to be used as a salt</return>
